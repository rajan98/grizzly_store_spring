                ...
                <div class="col-md-9 bg-light">
                    ...
                    <div class="btn-group col-md-12">
                        ...
                        <div class="col-md-12 bg-light">
                                <form class="mx-2 my-auto d-inline w-20" action="ShowProductByCategoryController" method="POST">
                                        <div class="input-group">
...
<option value="">Sort by Rating</option>
 <option value="http://localhost:8020/grizzlystore/SortByRatingController?order=LowToHigh">Low To High</option>
 <option value="http://localhost:8020/grizzlystore/SortByRatingController?order=HighToLow">High To Low</option>
</select>  &emsp;&emsp;&emsp;&emsp;&emsp;
</form>
		<form class= "mx-2 my-auto w-full" action="Admin-ListProducts.html" method="POST">
...
<form>
                        ...
                        <tr>
                          ...
                          <td>
                            <center>
                              <a href="viewProductController?id=${product.productId}" class="btn btn-secondary form-rounded"  width="50px"> &emsp;View&emsp; 
                              </a>&emsp;&emsp;
								
                              <button class="btn btn-secondary form-rounded" type="button"> &emsp;Block&emsp; 
                              </button>&emsp;&emsp;
                              <a  href="deleteProductController?id=${product.productId}" class="btn btn-secondary form-rounded">&nbsp;Remove&nbsp; 
                              </a>
                            </center>
                          </td>
                        </tr>
