                    ...
                    <ul class="navbar-nav ml-auto">
                        <li class="nav-item">
                            <form class="mx-2 my-auto w-full">
                               <a href="LogoutController" class="btn btn-secondary  form-rounded" >Logout
                ...
                <div class="col-md-9 bg-light">
                    ...
                    <div class="btn-group col-md-12">
                        ...
                        <div class="col-md-12 bg-light">
                                <form class="mx-2 my-auto d-inline w-20" action="VendorShowProductByProductIdController" method="POST">
                                        <div class="input-group">
                                            <input list="category" name="browser" class="form-rounded" placeholder=" Choose Action">
                                            <datalist id="category">
                                              <option value="Delete All" selected>
                                              <option value="Fridge All">
                                             </datalist>    

                                                    &emsp;&nbsp;&nbsp;
                                                    <input type="text" name="productId" class="form-rounded border border-right-0" placeholder=" Product Name/ID">
                                                    <span class="input-group-append">
...
<option value="">Select-Sorting Type</option>
 <option value="http://localhost:8020/grizzlystore/VendorSortByRatingController?order=LowToHigh">Ratings-Low To High</option>
 <option value="http://localhost:8020/grizzlystore/VendorSortByRatingController?order=HighToLow">Ratings-High To Low</option>
                          ...
                          <td>
                            <center>
                              ...
                              <div id="menu1" class="container tab-pane fade"><br>
                                <form class="mx-2 my-auto d-inline w-20" action="VendorShowProductByCategoryController" method="POST">
                                        <div class="input-group">
                                            <input list="category" name="browser" class="form-rounded" placeholder=" Choose Action">
                                            <datalist id="category">
...
<option value="">Select-Sorting Type</option>
 <option value="http://localhost:8020/grizzlystore/VendorSortByRatingController?order=LowToHigh">Low To High</option>
 <option value="http://localhost:8020/grizzlystore/VendorSortByRatingController?order=HighToLow">High To Low</option>
</select>  &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;</form>
                                   <form class= "mx-2 my-auto w-full" action="RedirectToAddProductServlet" method="POST">
                                         <a href="Admin-AddProduct.html" class="btn btn-dark form-rounded" >Add Product</a>
					<br></form></div>
