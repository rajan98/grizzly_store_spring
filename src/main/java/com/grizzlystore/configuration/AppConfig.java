package com.grizzlystore.configuration;
...
@ComponentScans(value={@ComponentScan("com.grizzlystore.dao"),
@ComponentScan("com.grizzlystore.service")
})
public class AppConfig {
	...
	public LocalSessionFactoryBean getSessionFactory()
	{
		...
		sessionFactoryBean.setPackagesToScan("com.grizzlystore.bean");
